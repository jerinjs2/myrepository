...
lwip/src/core/ipv4/%.o: ../lwip/src/core/ipv4/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M3 -I"/home/jerin/Work/myrepository/mcu/lpc_chip_175x_6x/inc" -I"/home/jerin/Work/myrepository/mcu/lpc_board_nxp_lpcxpresso_1769/inc" -I"/home/jerin/Work/myrepository/mcu/lwip_tcpecho_freertos/example/inc" -I"/home/jerin/Work/myrepository/mcu/lwip_tcpecho_freertos/lwip/inc" -I"/home/jerin/Work/myrepository/mcu/lwip_tcpecho_freertos/lwip/inc/ipv4" -I"/home/jerin/Work/myrepository/mcu/lwip_tcpecho_freertos/freertos/inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -mcpu=cortex-m3 -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
